        ...
        array(
            ...
            'items' => array(
                ...
                array(
                    ...
                    'a' => __( 'Para o órgão que fiscaliza barragens e para o empreendedor que responde por elas. O sistema tem seis perfis de acesso — administrador, analista de fiscalização, fiscal de campo, empresa contratada, empreendedor e usuário base — e cada item de menu declara quais perfis o enxergam.', 'sisb' ),
                ),
                array(
        ...
        array(
            ...
            'items' => array(
                ...
                array(
                    ...
                    'a' => __( 'A sincronização é bidirecional: o aparelho envia o que produziu e recebe o que mudou no servidor. O conteúdo de cada troca fica registrado, o que permite auditar divergências e reconstruir o que foi enviado por qual dispositivo.', 'sisb' ),
                ),
                array(
        ...
        array(
            ...
            'items' => array(
                ...
                array(
                    ...
                    'a' => __( 'Não. Cada nova integração é construída sobre a API, com mapeamento de campos definido caso a caso. O que já está pronto é a porta de entrada: emissão, regeneração e desativação de chaves de serviço, e documentação publicada pela própria API.', 'sisb' ),
                ),
                array(
                ...
                array(
                    ...
                    'a' => __( 'Não há prazo padrão a publicar. O tempo depende do volume e do estado da base a migrar, da definição das unidades e dos perfis e da preparação dos modelos de notificação e de relatório — trabalho de serviço, que existe além do software. A estimativa é feita caso a caso, a partir desses pontos.', 'sisb' ),
                ),
            ),
        ),
