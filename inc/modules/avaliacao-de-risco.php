...
return array(
    ...
    'problema'  => array(
        ...
        __( 'E o resultado envelhece sem deixar rastro. Meses depois, ninguém consegue dizer quais respostas produziram aquela categoria. Isso fragiliza o órgão justamente quando a classificação é contestada.', 'sisb' ),
    ),

    'como_funciona' => array(
        array(
            'title' => __( 'Características técnicas da estrutura', 'sisb' ),
            'text'  => __( 'A avaliação começa pelos dados construtivos da barragem, que compõem a primeira parte da Categoria de Risco.', 'sisb' ),
        ),
        array(
